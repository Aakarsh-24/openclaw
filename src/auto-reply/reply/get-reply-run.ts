...
export async function runPreparedReply(
  ...
  const mediaReplyHint = mediaNote
    ? "To send an image back, prefer the message tool (media/path/filePath). If you must inline, use MEDIA:https://example.com/image.jpg (spaces ok, quote if needed) or a local path under the agent workspace or ~/.openclaw/media (e.g., MEDIA:./image.jpg for files in your workspace). Private/loopback URLs and local paths outside allowed roots are blocked. Keep caption in the text body."
    : undefined;
