...
export function applyLlmgatewayProviderConfig(cfg: ClawdbotConfig): ClawdbotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyLlmgatewayConfig(cfg: ClawdbotConfig): ClawdbotConfig {
