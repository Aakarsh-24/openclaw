...
services:
  - type: web
    ...
    dockerCommand: sh -c "mkdir -p /data/.openclaw && echo '{\"gateway\":{\"controlUi\":{\"dangerouslyDisableDeviceAuth\":true}}}' > /data/.openclaw/openclaw.json && node dist/index.js gateway --bind lan --port 8080"
    envVars:
      - key: PORT
        value: "8080"
      - key: SETUP_PASSWORD
