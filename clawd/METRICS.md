...
Reports stored in `~/clawd/memory/self-eval-YYYY-MM-DD.md`

### Targets

| Metric | Target | Why |
|--------|--------|-----|
| APEX Compliance | >80% | Core protocol adherence |
| Response Latency | <30s simple | User experience |
| Token Efficiency | <5k/task | Cost control |
